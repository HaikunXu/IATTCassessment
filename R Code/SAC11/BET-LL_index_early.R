...
DateFile = paste0(Dir,"BET_vessel_Early_HBF_Area/")
...
Data_Geostat = cbind( Data_Geostat, "knot_i"=Spatial_List$knot_i) %>% filter(Year<73) # 1979-1992

save(Data_Geostat,Data_Geostat_Grid,file=paste0(DateFile,"Early_Data.RData")) # save model inputs
